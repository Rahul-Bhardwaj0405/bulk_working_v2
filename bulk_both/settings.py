"""
Django settings for bulk_both project.
...
SECRET_KEY = 'django-insecure-piov4)vqbv3@=92_!$vm7dz@2stv9*1k9+qyu+vvepppl41lz_'
...
WSGI_APPLICATION = 'bulk_both.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'irctc_one',  # Replace with your actual database name
